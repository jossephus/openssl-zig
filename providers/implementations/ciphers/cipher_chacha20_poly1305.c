...
static int chacha20_poly1305_get_ctx_params_find_pidx(const char *s)
{
    switch(s[0]) {
    default:
        break;
    case 'i':
        if (strcmp("vlen", s + 1) == 0)
            return 1; /* PIDX_CIPHER_PARAM_IVLEN */
        break;
    case 'k':
        if (strcmp("eylen", s + 1) == 0)
            return 0; /* PIDX_CIPHER_PARAM_KEYLEN */
        break;
    case 't':
        switch(s[1]) {
        default:
        ...
        case 'a':
            ...
            case 'g':
                ...
                case 'l':
                    if (strcmp("en", s + 4) == 0)
                        return 2; /* PIDX_CIPHER_PARAM_AEAD_TAGLEN */
                    break;
                case '\0':
                    return 3; /* PIDX_CIPHER_PARAM_AEAD_TAG */
                }
            }
            break;
        case 'l':
            if (strcmp("saadpad", s + 2) == 0)
                return 4; /* PIDX_CIPHER_PARAM_AEAD_TLS1_AAD_PAD */
        }
    }
    return -1;
}
...
static int chacha20_poly1305_set_ctx_params_find_pidx(const char *s)
{
    switch(s[0]) {
    default:
        break;
    ...
    case 't':
        ...
        case 'a':
            if (strcmp("g", s + 2) == 0)
                return 2; /* PIDX_CIPHER_PARAM_AEAD_TAG */
            break;
        case 'l':
            switch(s[2]) {
            default:
            ...
            case 's':
                ...
                case 'a':
                    if (strcmp("ad", s + 4) == 0)
                        return 3; /* PIDX_CIPHER_PARAM_AEAD_TLS1_AAD */
                    break;
                case 'i':
                    if (strcmp("vfixed", s + 4) == 0)
                        return 4; /* PIDX_CIPHER_PARAM_AEAD_TLS1_IV_FIXED */
                }
            }
        }
    }
